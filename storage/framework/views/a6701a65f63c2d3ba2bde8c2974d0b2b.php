...
<body>
    <form id="emailForm" action="<?php echo e(route('sendmail')); ?>" method="POST">
        <?php echo csrf_field(); ?>
    ...
    <script>
        document.getElementById('emailForm').addEventListener('submit', function(event) {
            ...
            fetch("<?php echo e(route('sendmail')); ?>", {
                method: 'POST',
                headers: {
...
</html><?php /**PATH D:\pmwatis\fd-borrow\resources\views/testSendMail.blade.php ENDPATH**/ ?>